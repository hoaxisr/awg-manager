...
// печати незачем: dup2 накрывает и их, и любых хелперов, которых процесс
// породит, потому что дескрипторы 1 и 2 наследуются. Заодно исчезает SIGPIPE:
// файл, в отличие от пайпа к умершему менеджеру, всегда доступен на запись.
