 ...
 *
 * «Получено вне AWG-M» — последняя и самая слабая: она говорит лишь, что
 * страна УЖЕ занимает слот подписки, хотя конфигурацию по ней выдавали не мы.
 * Любая из трёх предыдущих меток сообщает то же самое и притом конкретнее,
 * поэтому перебивает её.
 *
