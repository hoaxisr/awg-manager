...
<style>
	...
	@media (max-width: 640px) {
		/* Гуттер контейнера на мобильном — 0.75rem (--layout-gutter-x, app.css),
		   поэтому поля полосы тоже 0.75rem: с десктопным -1rem она вылезала за
		   край и давала горизонтальный скролл у .shell-content.
