...
<SettingRows>
	...
	>
		...
		<p class="ft-hint ft-span">
			Несколько ссылок дают несколько независимых пулов TURN-кредов — больше суммарных
			потоков и меньше риск бана одного звонка. VK-капча решается автоматически в headless
			Chrome на роутере.
		</p>
		<div class="ft-span">
			<Input
