...
export const CLIENT_TEXT = {
	...
	/** Гейт «Запустить» у сервера без главного пароля — причина глубже, чем
	 *  отсутствие абонентов: без пароля их и не завести. */
	startNoPassword: 'Сервер не запускается без главного пароля — задайте его в разделе «Сеть»',
	/** TS-14 */
	passwordIsMain:
