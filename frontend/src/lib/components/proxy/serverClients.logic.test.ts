...
describe('матрица кнопок §4.4', () => {
	// Кнопки ссылки в матрице больше нет: она есть у КАЖДОГО абонента, и
	// доступность пинают рендер-тесты (`ServerClients.test.ts`, роль
	// «Ссылка» у рабочего и у гостя).
	it('рабочий: перевыпуск есть, удаление разрешено', () => {
