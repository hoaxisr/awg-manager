      ...
      <section class="sec">
        ...
        {:else}
          <p class="hint warn-text">
            ...
            они переустановятся сами, уже через прокси. Пока движок поднимается, трафик членов
            политики заблокирован — до минуты, вместе с DNS.
          </p>
          <p class="hint">
            Пока режим включён, весь IPv4-трафик членов политики идёт через sing-box: потоки,
            успевшие уйти мимо перехвата, вытесняются.
