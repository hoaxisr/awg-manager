    ...
    <div class="rules-section">
      ...
      {#if prefixLen > 0}
        ...
        <p class="numbering-note">
          ...
          <!-- Состав префикса перечислять нельзя: он разный у режимов (в
               fakeip нет sniff), и жёсткий список врал бы через раз. -->
          (перехват DNS, приватные сети и прочая механика режима), которых нет на странице правил.
