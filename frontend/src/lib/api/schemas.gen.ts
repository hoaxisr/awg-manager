...
export const RESPONSE_SCHEMAS: Record<string, v.GenericSchema> = {
	...
	"GET /system/files/checksum": v.record(v.string(), v.unknown()),
	"GET /system/files/download": v.record(v.string(), v.unknown()),
	"GET /system/files/list": v.record(v.string(), v.unknown()),
	"GET /system/files/read": v.record(v.string(), v.unknown()),
	"GET /system/files/roots": v.record(v.string(), v.unknown()),
	"GET /system/files/script-status": v.record(v.string(), v.unknown()),
	"GET /system/hydraroute-status": v.lazy(() => api_HydraRouteStatusResponse),
	"GET /system/info": v.lazy(() => api_SystemInfoResponse),
	"GET /system/opkg/available": v.record(v.string(), v.unknown()),
	"GET /system/opkg/installed": v.record(v.string(), v.unknown()),
	"GET /system/opkg/search": v.record(v.string(), v.unknown()),
	"GET /system/opkg/upgradable": v.record(v.string(), v.unknown()),
	"GET /system/ports/inspect": v.record(v.string(), v.unknown()),
	"GET /system/ports/list": v.record(v.string(), v.unknown()),
	"GET /system/services/get": v.record(v.string(), v.unknown()),
	"GET /system/services/list": v.record(v.string(), v.unknown()),
	...
	"POST /system/files/chmod": v.record(v.string(), v.unknown()),
	"POST /system/files/copy": v.record(v.string(), v.unknown()),
	"POST /system/files/mkdir": v.record(v.string(), v.unknown()),
	"POST /system/files/remove": v.record(v.string(), v.unknown()),
	"POST /system/files/rename": v.record(v.string(), v.unknown()),
	"POST /system/files/script-action": v.record(v.string(), v.unknown()),
	"POST /system/files/upload": v.record(v.string(), v.unknown()),
	"POST /system/files/write": v.record(v.string(), v.unknown()),
	"POST /system/hydraroute-control": v.lazy(() => api_APIEnvelope),
	"POST /system/opkg/install": v.record(v.string(), v.unknown()),
	"POST /system/opkg/remove": v.record(v.string(), v.unknown()),
	"POST /system/opkg/update": v.record(v.string(), v.unknown()),
	"POST /system/opkg/upgrade": v.record(v.string(), v.unknown()),
	"POST /system/ports/kill": v.record(v.string(), v.unknown()),
	"POST /system/proc/kill": v.record(v.string(), v.unknown()),
	"POST /system/proc/snapshot": v.record(v.string(), v.unknown()),
	"POST /system/restart": v.lazy(() => api_APIEnvelope),
	"POST /system/services/action": v.record(v.string(), v.unknown()),
	"POST /system/services/delete": v.record(v.string(), v.unknown()),
	"POST /system/services/save": v.record(v.string(), v.unknown()),
