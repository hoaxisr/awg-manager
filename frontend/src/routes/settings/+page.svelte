        ...
        <div class="credits-section">
            ...
            <div class="card">
                <div class="credits-content">
                    ...
                    <span class="credits-nikc">@N0news</span>
                    <span class="credits-nikc">@zixstass</span>
                    <span class="credits-nikc">@Agenstily</span>
                    <span class="credits-nikc">@Russlan_89</span>
                    <span class="credits-nikc">@fr0z3n_rzr</span>
                    <span class="credits-nikc">@boris_e</span>
                    <span class="credits-nikc">@Vgjkuj</span>
                    <span class="credits-nikc">@tkrv09</span>
                    <span class="credits-nikc">@Sadrutdin</span>
                    <span class="credits-nikc">@Clawa1984</span>
                    <span class="credits-nikc">@beautiful_lion</span>
                    <span class="credits-nikc">@Link_Sergey</span>
                    <span class="credits-nikc">@Dannis_CH</span>
                    <span class="credits-nikc">@vano_milah</span>
                    <span class="credits-nikc">@Il131</span>
                    <span class="credits-nikc">@VylenSV</span>
                    <span class="credits-nikc">@verbee09</span>
                    <span class="credits-nikc">@EfimovYuriy</span>
                    <span class="credits-nikc">@vumaximov</span>
                    <span class="credits-nikc">@Maximus</span>
                    <span class="credits-nikc">@VlZlVlZ</span>
                    <span class="credits-nikc">@sergeinesl</span>
                    <span class="credits-nikc">@unclownartist</span>
                    <span class="credits-nikc">@game47</span>
                    <span class="credits-nikc">@A_Valerich</span>
                    <span class="credits-nikc">@Влад*** С***н</span>
                    <span class="credits-nikc">@Space_Voyager_Telegram</span>
                    <span class="credits-nikc">@moskinnickolas</span>
                    <span class="credits-nikc">@Brown2Fox</span>
                    <span class="credits-nikc">@Mr_SiB</span>
                    <span class="credits-nikc">@moskinnickolas</span>
                    <span class="credits-nikc">@moskinnickolas</span>
                </div>
            </div>
