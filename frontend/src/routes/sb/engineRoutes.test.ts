...
// Здесь стояла XOR-связка «маркер временного содержимого „Движка“ ↔ ссылка
// заглушек на него» (5D1). Волна 5D2a сняла обе половины разом, и связка стала
// сравнением двух отсутствий. Обещание заглушек теперь проверяет рендером
// `lib/components/sb-group/GroupStub.test.ts`.
