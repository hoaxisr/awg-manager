<script module lang="ts">
	/**
	 * Маркер временного содержимого — страховка от молчаливого протухания.
	 *
	 * Шесть заглушек группы (`GroupStub`) обещают, что до своей волны функция
	 * живёт «на странице „Движок“». Обещание верно ровно пока «Движок» несёт
	 * содержимое старой `/sb/routing`. Волна 5D2a вынесет его отсюда и снимет
	 * этот маркер вместе с ним — сверка в `routes/sb/engineRoutes.test.ts`
	 * покраснеет и напомнит перенацелить заглушки.
	 *
	 * Значение не читает никто, смысл — в существовании константы: комментарий
	 * можно переписать мимоходом, константу удаляют осознанно.
	 */
	export const TEMP_UNTIL_5D2A = true;
</script>
