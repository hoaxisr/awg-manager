...
// NewUserspaceWithConfig creates a userspace backend with custom configuration.
func NewUserspaceWithConfig(pidDir, socketDir, binary string, env []string) *UserspaceBackend {
	return &UserspaceBackend{
		pidDir:    pidDir,
		socketDir: socketDir,
		binary:    binary,
