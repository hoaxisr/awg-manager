...
func (m *MockNDMSClient) AddHostRoute(ctx context.Context, host, via string) error  { return nil }
...
func (m *MockNDMSClient) IsDHCPClientBound(ctx context.Context, iface string) bool   { return false }
