...
// защищён; но переключение режима перезагружает движок (SIGHUP закрывает и
// заново открывает все слушатели, бинарь не из пина — полный рестарт), и в
// это окно ядро вправе отдать порт локальным концом любого
