...
// РЕЗИДУАЛ ВОЛНЫ: пока движок не проведён (план 5), реестр пуст, а зеркальные
// записи ведёт старый код. backendWdttRaw — копия wdtt.BackendWdttRaw
...
// Обе константы и весь фолбэк снимает план 5.
const (
...
// потому что движок ещё не проведён (план 5). У такого ответа готовность
// неизвестна, и её досматривает вызывающий прежним способом. Ветка уходит
// вместе с зеркальными записями.
