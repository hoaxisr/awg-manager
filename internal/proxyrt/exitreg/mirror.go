...
// Remove сносит ОДНУ зеркальную запись по id — ту, чей инстанс удаляют — и
// говорит, была ли она наша.
//
...
// запись. Без адресного сноса она пережила бы удаление инстанса навсегда:
